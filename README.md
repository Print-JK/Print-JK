...
### Vulpilot: PenTest Report Automation
> **Developed a FastAPI application to convert Nmap/Nuclei scan outputs into professional HTML/PDF penetration testing reports.**
* **Tech Stack:** ![Python](https://img.shields.io/badge/python-3670A0?style=flat-square&logo=python&logoColor=ffdd54) ![FastAPI](https://img.shields.io/badge/FastAPI-009688?style=flat-square&logo=fastapi&logoColor=white) ![Ollama](https://img.shields.io/badge/Ollama-316192?style=flat-square&logo=postgresql&logoColor=white)
* **Key Feature:** Implemented a modular parsing pipeline with finding normalization, severity standardization, and integrated optional LLM summarization for reliable executive reports.
* **Outcome:** Automated the complex process of translating raw scan data into actionable security intelligence.

---

### Sigma-Webapps: Client-Side Security Suite
> **Developed a privacy-first web application suite for document processing using modern browser APIs.**
